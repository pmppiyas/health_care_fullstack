...
import AppointmentHeader from "@/components/dashboard/admin/appointment/AppointmentHeader"
import { getAppointmentColumns } from "@/components/dashboard/admin/appointment/AppointmentColumn"
...
export default function AppointmentWrapper() {
  ...
  const handleView = (a: Appointment) =>
    router.push(`/admin/dashboard/appointments/${a._id}`)

  const handleEdit = (a: Appointment) =>
    router.push(`/admin/dashboard/appointments/${a._id}/edit`)
