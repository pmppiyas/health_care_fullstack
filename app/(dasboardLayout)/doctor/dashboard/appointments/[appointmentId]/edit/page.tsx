...
const DOCTOR_BASE_PATH = "/doctor/dashboard/appointments"
...
function EditContent({ appointmentId }: { appointmentId: string }) {
  ...
  return (
    <div className="space-y-0">
      <CreateAppointmentHeader basePath={DOCTOR_BASE_PATH} />
...
export default function DoctorAppointmentEditPage({
  params,
}: {
